...
<head>
    ...
    <meta name="description" content="Dr. Yao Jiani - Aestethic Surgery, Botox, Fillers" />
    <meta name="keywords" content="Dr., Dr, Yao, Jiani, Aestethic, Surgery, Botox, Fillers, Business" />
                    ...
                    <div class="row flex-v-center">
                        <div class="col-md-8 col-lg-7 col-sm-12 col-xs-12">
                            <div class="welcome-text">
                                ...
                                <h4>Invite others to join your world and help shape it.</h4>
                                <h4>Set the rules of your world exactly as you want them.</h4>
                                @if (Route::has('login'))
                                    <div>
                                        @auth
                                            <button class="">
        ...
        <div class="row promo-content">
            <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                <div class="text-icon-box mb20 xs-mb0 wow fadeInUp padding30" data-wow-delay="0.1s">
                    ...
                    <h3 class="box-title">Some fancy info</h3>
            ...
            <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                <div class="text-icon-box relative mb20 xs-mb0  wow fadeInUp padding30" data-wow-delay="0.2s">
                    ...
                    <h3 class="box-title">SOme bla bla</h3>
                    <p>A Google Docs scam that appears to be widespread began landing in Wednesday in what seemed to be a phishing attack.</p>
                </div>
            </div>
            <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
        ...
        <div class="row">
            <div class="col-md-8 col-lg-8 col-md-offset-2 col-lg-offset-2 col-sm-12 col-xs-12">
                <div class="text-center wow fadeIn">
                    <h2 class="xs-font20">Try a demo pixel sotry bellow:</h2>
                    <p>Show the demo stry here with possibility to add </p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-8 col-lg-8 col-md-offset-2 col-lg-offset-2 col-sm-12 col-xs-12">
                <div class="area-title text-center wow fadeIn">
                    <h2 class="xs-font26">Most popular stories</h2>
                </div>
            </div>
        </div>
...
<section class="course-area padding-top" id="courses">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-8 col-lg-8 col-md-offset-2 col-lg-offset-2 col-sm-12 col-xs-12">
                <div class="area-title text-center wow fadeIn">
                    <h2 class="xs-font26">Newest stories</h2>
                </div>
            </div>
        </div>
        <div class="row course-list">
